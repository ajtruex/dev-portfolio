...
const PopoverDemo = () => (
  <div className="flex items-center justify-center">
    <Popover.Root className="flex items-center justify-center mx-auto">
      <Popover.Trigger asChild>
        <button
          className="rounded-full w-[35px] h-[35px] flex items-center justify-center text-violet11 bg-white shadow-[0_2px_10px] shadow-blackA7 hover:bg-violet3 focus:shadow-[0_0_0_2px] focus:shadow-black cursor-default outline-none"
